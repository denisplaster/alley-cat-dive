...
const BASE_URL = "https://alleycatdive.com";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/crew", changefreq: "weekly", priority: "0.7" },
          { path: "/hideout", changefreq: "weekly", priority: "0.7" },
          { path: "/inventory", changefreq: "weekly", priority: "0.6" },
