...
export function RoomPath({ rooms, current }: { rooms: Room[]; current: number }) {
  return (
    <div className="chunky-panel h-full bg-black/85 px-2 py-1">
      <div className="mb-0.5 flex items-center justify-between text-[9px] font-bold uppercase tracking-widest text-muted-foreground">
        <span>Run Path</span>
        ...
        {rooms.map((r, i) => {
          ...
          return (
            <div key={i} className="flex items-center gap-1 shrink-0">
              <div className={`relative flex size-7 md:size-8 items-center justify-center chunky-panel text-sm md:text-base
